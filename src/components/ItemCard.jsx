...
const ItemCard = ({model, brand, details, price, imageURL}) => {

  const navigate = useNavigate();

  const onClickDetail = (model) => {
    navigate(`/producto/${model}`);
  }

//className="group relative flex flex-wrap justify-start items-start w-72 bg-slate-100 border-b-2 border-b-teal-600 rounded-md shadow-lg hover:shadow-xl dark:border-teal-400 dark:bg-gray-800"
